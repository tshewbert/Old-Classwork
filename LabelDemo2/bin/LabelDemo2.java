...
*1. Set up new frame to to run the program in
*2. Set up the images to be used as the ImageIcons for the JLabels
*3. Create four JLabels, the text to display next to the ImageIcon, and the alignment of the
*	text and the ImageIcon
*4. Create a within the frame a JPanel for the JLabels to be displayed
*/
public class LabelDemo2
{
	public static void main (String[] args)
	{
		...
		//Creates a panel to display the for labels
